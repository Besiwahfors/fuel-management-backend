...
export class AddFuelTypeAndQuantity1743003857255 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('admin', 'manager')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transaction_paymentmethod_enum" AS ENUM('cash', 'momo')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."transaction_fueltype_enum" AS ENUM('petrol', 'diesel', 'premium', 'electric')`,
    );
    await queryRunner.query(
      `CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "amount" numeric(10,2) NOT NULL, "quantity" numeric(10,2) NOT NULL, "paymentMethod" "public"."transaction_paymentmethod_enum" NOT NULL, "fuelType" "public"."transaction_fueltype_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "stationId" integer, "attendantId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "attendant" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "stationId" integer, CONSTRAINT "UQ_5650b63eb1b32419e44cb74526e" UNIQUE ("code"), CONSTRAINT "PK_0f816ac9013a3351bfb034bdc2a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "station" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "location" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_0c4cf3382f77cddaf304687e95c" UNIQUE ("name"), CONSTRAINT "PK_cad1b3e7182ef8df1057b82f6aa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TYPE "public"."transaction_paymentmethod_enum"`,
    );
